...
SS::WebpageServer::WebpageServer() : SimpleServer(AF_INET, SOCK_STREAM, 0, 8080, INADDR_ANY, 10)
{
    launch();
}
void SS::WebpageServer::accepter()
{
...
void SS::WebpageServer::handler()
{
    std::cout << buffer << std::endl;
}
void SS::WebpageServer::responder()
{
